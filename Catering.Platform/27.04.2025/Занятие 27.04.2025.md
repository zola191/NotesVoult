...
1. копируем body --> создаем etag --> ndify или SCHA256 (простой алгоритм)
2. сравнить If-None-Match если возвращаем 304 без body
3. если 
...
в рамках catering кэшируем Get далее будем использовать при авторизации и ауэтентификации 