...
есть два способа показывания информация об ошибке
...
2.  app.UseStatusCodePagesWithRedirects("/Error/{0}"); redirect на специфичную страницу, актуально для Razor, в web api не используют